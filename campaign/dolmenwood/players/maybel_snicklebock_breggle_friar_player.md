---
tags: [character, pc, breggle, friar, level-1]
name: Maybel Snicklebock
kindred: Breggle
class: Friar
level: 1
alignment: Neutral
...
# Maybel Snicklebock — Breggle Friar
**Kindred:** Breggle (Mortal, Medium)
**Class:** Friar · Level 1
**Alignment:** Neutral
**Background:** Alchemist's assistant
**Languages:** Woldish, Gaffe, Caprice, Liturgic
...
|-----|-----|-----|-----|-----|-----|
| 11 (+0) | 9 (+0) | 4 (-2) | 10 (+0) | 17 (+2) | 7 (-1) |

**Prime Ability:** Intelligence and Wisdom (9, 4) → **XP Modifier: -20%**
...
| Skill | Target | Roll |
|-------|--------|------|
| Survival (foraging) | 5 | d6, equal or beat target |
...
- **Head:** Spiky ginger hair
- **Face:** Small eyes, close set
- **Fur:** Tan, shaggy
- **Dress:** Long skirts and cloak
- **Demeanour:** Single-minded, stubborn
- **Desires:** Found a crime syndicate
- **Beliefs:** Nag-Lord is breggle messiah
- **Speech:** Throaty
...
**Wants:** Found a crime syndicate

**Believes:** Nag-Lord is breggle messiah
