---
tags: [character, pc, breggle, hunter, level-1]
name: Hraigl Hwodlow
kindred: Breggle
class: Hunter
level: 1
...
# Hraigl Hwodlow — Breggle Hunter
**Kindred:** Breggle (Mortal, Medium)
**Class:** Hunter · Level 1
**Alignment:** Lawful
**Background:** Beekeeper
...
|-----|-----|-----|-----|-----|-----|
| 7 (-1) | 7 (-1) | 6 (-1) | 15 (+1) | 9 (+0) | 11 (+0) |

**Prime Ability:** Constitution and Dexterity (9, 15) → **XP Modifier: +0%**
...
| Item | Details |
|------|---------|
| Armour | Leather armour + shield |
| Weapon 1 | Shortsword |
| Weapon 2 | Sling + 20 stones |
...
| Skill | Target | Roll |
|-------|--------|------|
| Alertness | 6 | d6, equal or beat target |
| Stalking | 6 | d6, equal or beat target |
| Survival | 5 | d6, equal or beat target |
| Tracking | 5 | d6, equal or beat target |

---

## Kindred Traits (Breggle)
...
- **Head:** Slick, oiled hair
- **Face:** Golden eyes
- **Fur:** Russet, wavy
- **Dress:** Long skirts and cloak
- **Demeanour:** Flighty, mercurial
- **Desires:** Swindle Lord Murkin's wealth
- **Beliefs:** Breggles originate in Fairy
- **Speech:** Lackadaisical
...
**Wants:** Swindle Lord Murkin's wealth

**Believes:** Breggles originate in Fairy
